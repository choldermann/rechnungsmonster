  ...
  return (
    <LegalLayout title="Impressum" activePage="impressum">
      ...
      <section>
        ...
        <p>
          Die von Rechnungsmonster ausgegebenen Validierungsergebnisse stellen keine
          Rechts-, Steuer- oder Wirtschaftsberatung dar. Für die Richtigkeit,
          Vollständigkeit und Aktualität der Prüfergebnisse wird keine Gewähr
          übernommen.
        </p>
      </section>
